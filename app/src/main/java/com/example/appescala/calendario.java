...
public class calendario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendar.init(lastYear.getTime(), nextYear.getTime(), new SimpleDateFormat("MMMM,YYYY", Locale.getDefault())) //
                ...
                .withDeactivateDates (new ArrayList <> (Collections.singletonList (null)));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(calendario.this, "list " + calendar.getSelectedDates().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private ArrayList<SubTitle> getSubTitles() {
        ...
        subTitles.add(new SubTitle(tmrw.getTime(), "Deusmio"));
        return subTitles;
    }
}